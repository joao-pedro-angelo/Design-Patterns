package PITSa.src.main.java.com.ufcg.psoft.commerce.model.pedido;
...
public class Pedido {
    ...
    public void setStatus(StatePedido status) {
        this.status = status;
        this.status.setPedido(this); // Atribui o pedido ao status
    }
